...
import Avatar from 'url:./img/log-3.png';
import NearLogo from 'url:./img/ufo.png';
	...
	return <>
...

		{
			signedIn && <div id="tabs">
				<div onClick={() => update('app.tab', 1)} style={{ background: tab === 1 ? '#fed' : '' }}>Market Insurance</div>
				<div onClick={() => update('app.tab', 2)} style={{ background: tab === 2 ? '#fed' : '' }}>My Insurance</div>
				<div onClick={() => update('app.tab', 3)} style={{ background: tab === 3 ? '#fed' : '' }}>Buy Insurance</div>
			</div>
		}
